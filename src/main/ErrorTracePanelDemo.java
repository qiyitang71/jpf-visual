...
public class ErrorTracePanelDemo extends ShellPanel implements VerifyCommandListener {
	...
	public ErrorTracePanelDemo() {
		super("Error Trace Demo", null, "View JPF's Output");
		...
		JScrollPane errorTraceScroll = new JScrollPane(new ErrorTrace());
		...
		splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, listScroll, errorTraceScroll);
